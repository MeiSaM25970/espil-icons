...
const SvgClockDark = ({
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M7.957 15.77a.75.75 0 0 1-.768-.307.75.75 0 0 1 .026-.893c.1-.134.254-.208.395-.29l4.096-2.364q-.82-1.415-1.634-2.832a.753.753 0 0 1 .3-1.017.75.75 0 0 1 .997.267q1.006 1.74 2.01 3.481a.75.75 0 0 1-.068.85c-.102.132-.256.203-.395.284l-4.58 2.645c-.12.069-.24.15-.38.175"
      opacity={0.5}
    />
  </svg>
);
