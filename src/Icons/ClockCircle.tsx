...
const SvgClockCircle = ({
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M11.325 7.679a.752.752 0 0 1 1.25-.144c.109.13.17.3.17.47V11.7l2.286 2.286a.751.751 0 0 1-1.062 1.06l-2.496-2.496a.76.76 0 0 1-.227-.537V8.075a.8.8 0 0 1 .079-.396"
    />
  </svg>
);
